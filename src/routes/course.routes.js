...
courseRouter.post('/modules/:id/lessons', credentialsHandler, lessonValidator, validationErrorHandlerUtil, courseController.createLesson);
courseRouter.get('/lessons/:id', credentialsHandler, courseController.getSelectedLesson);
